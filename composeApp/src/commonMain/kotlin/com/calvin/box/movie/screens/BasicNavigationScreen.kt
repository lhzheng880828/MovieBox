...
data class BasicNavigationScreen(
    ...
    override fun Content() {
        LifecycleEffect(
            onStarted = { Napier.e(tag ="Navigator" , message = "Start screen #$index") },
            onDisposed = { Napier.e(tag = "Navigator", message =  "Dispose screen #$index") }
        )
       /* LifecycleEffectOnce {
            Napier.d("Navigator", "On screen first appear #$index")
        }*/
